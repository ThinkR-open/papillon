...
[![R build status](https://github.com/ThinkR-open/chameleon/workflows/R-CMD-check/badge.svg)](https://github.com/ThinkR-open/chameleon/actions)
<!-- badges: end -->
...
<!-- description: start -->
This is package {chameleon}: Build And Highlight Package Documentation With Customized
    Templates.  
...
Please note that the 'chameleon' project is released with a
