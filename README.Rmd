...
[![Travis build status](https://travis-ci.org/ThinkR-open/chameleon.svg?branch=master)](https://travis-ci.org/ThinkR-open/chameleon)
<!-- badges: end -->
